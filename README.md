...
## 🍒 Работа с PowerShell и используемые команды
Итак, мы наконец то добрались до самого интересного,**работа с PowerShell**. Кратко пройдусь по всем нам нужным командам
- [**`Invoke-WebRequest`**] - загружает файл из интернета по указанному URL
- <ins>**`-Uri`** - параметр для ссылки файла(сюды мы пихаем ссылку что мы скачиваем)
